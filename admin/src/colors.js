...
export const gradientBgPurplePink = `${gradientBgBase} from-grey-200 via-grey-500 to-grey-500`;
export const gradientBgDark = `${gradientBgBase} from-slate-700 via-slate-900 to-slate-800`;
export const gradientBgPinkRed = `${gradientBgBase} from-gray-400 via-blue-500 to-yellow-500`;
